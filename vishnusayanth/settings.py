...
DEBUG = False
DEPLOYED = True
CSRF_TRUSTED_ORIGINS = ['https://vishnusayanth.github.io/']
if DEPLOYED:
    ALLOWED_HOSTS = ['*', 'https://vishnusayanth.github.io/']
else:
    ALLOWED_HOSTS = ['*']
...
MIDDLEWARE = [
    ...
    'utils.utility_functions.CustomRequestMiddleware'
]

ROOT_URLCONF = 'vishnusayanth.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'utils.utility_functions.custom_context',
            ],
        },
    },
]
...
WSGI_APPLICATION = 'vishnusayanth.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'utils.utility_functions.cleanup_social_account',
...
SOCIAL_AUTH_LINKEDIN_OAUTH2_FIELD_SELECTORS = ['formatted-name', ]
...
if DEPLOYED:
    MEDIA_ROOT = '/home/vishnusayanth/vishnusayanth/media'
    STATIC_ROOT = '/home/vishnusayanth/vishnusayanth/static'
else:
